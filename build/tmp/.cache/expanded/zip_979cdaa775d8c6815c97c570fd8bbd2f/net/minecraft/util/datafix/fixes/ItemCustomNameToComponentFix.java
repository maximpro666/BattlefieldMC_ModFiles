   ...
   private Dynamic<?> fixTag(Dynamic<?> p_15935_) {
      ...
      if (optional.isPresent()) {
         ...
         if (optional1.isPresent()) {
            dynamic = dynamic.set("Name", dynamic.createString(Component.Serializer.toJson(Component.literal(optional1.get()))));
         } else {
            Optional<String> optional2 = dynamic.get("LocName").asString().result();
            if (optional2.isPresent()) {
               dynamic = dynamic.set("Name", dynamic.createString(Component.Serializer.toJson(Component.translatable(optional2.get()))));
