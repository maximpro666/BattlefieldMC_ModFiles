...
import com.pigeostudios.pwp.network.OpenSpawnSelectionScreenPacket;
...
public class SpawnSelectionScreen extends Screen {
    ...
    private void renderSpawnCard(GuiGraphics g, int x, int y, int w, SpawnEntry e, boolean hovered, boolean selected, float fade, int alpha, int idx) {
        ...
        com.pigeostudios.pwp.client.gui.component.StatusDot.draw(g, x + 12, y + CARD_H / 2, e.safe ? com.pigeostudios.pwp.client.gui.component.StatusDot.Status.OK : com.pigeostudios.pwp.client.gui.component.StatusDot.Status.DANGER);
    ...
    private void renderRightPanel(GuiGraphics g, int leftW, int mx, int my, float fade, int alpha, int topH) {
        ...
        y += 22;
        com.pigeostudios.pwp.client.gui.component.AccentLine.draw(g, rx, y, Math.min(rw, 200), fade);
        y += 14;
            ...
            if (cfg != null) {
                ...
                if (cl != null) {
                    ...
                    if (kit != null && kit.requirements != null) {
                        ...
                        if (sp > 0 || bc > 0) {
                            StringBuilder sb = new StringBuilder(com.pigeostudios.pwp.client.gui.I18n.get("pwp.ui.buy_for"));
                            if (sp > 0) { sb.append(" ").append(sp).append("SP"); }
                            if (bc > 0) { if (sp > 0) sb.append(" +"); sb.append(" ").append(bc).append("BC"); }
                            costLabel = "> " + sb.toString();
                            int playerSP = com.pigeostudios.pwp.client.ClientTeamData.localPlayerWC;
                            int playerBC = com.pigeostudios.pwp.client.ClientTeamData.localPlayerBC;
