...
public final class ChatHelper {
    ...
    public static MutableComponent success(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_SUCCESS);
    }

    public static MutableComponent error(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_ERROR);
    }

    public static MutableComponent info(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_INFO);
    }

    public static MutableComponent warning(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_WARNING);
    }

    public static MutableComponent accent(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_ACCENT);
    }

    public static MutableComponent neutral(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_NEUTRAL);
    }

    public static MutableComponent bright(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_BRIGHT);
    }

    public static MutableComponent header(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_HEADER, PWPColors.CHAT_EMPHASIS);
    }

    public static MutableComponent highlight(String msg) {
        return Component.literal(msg).withStyle(PWPColors.CHAT_HIGHLIGHT);
    }
