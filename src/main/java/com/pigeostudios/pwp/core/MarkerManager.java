...
import com.pigeostudios.pwp.network.MarkerSyncPacket;
...
public class MarkerManager {
    ...
    public MarkerData addMarker(String name, String label, ResourceLocation dimension,
        ...
        markers.add(marker);
        syncToAll();
        PWP.LOGGER.info("Marker added: {} ({}) at ({}, {}, {})", name, label, x, y, z);
        return marker;
    }
    ...
    public boolean removeMarker(String name) {
        ...
        if (removed) {
            syncToAll();
            PWP.LOGGER.info("Marker removed: {}", name);
        }
        return removed;
    }
    ...
    public void clearMarkers() {
        markers.clear();
        syncToAll();
        PWP.LOGGER.info("All markers cleared");
    }
