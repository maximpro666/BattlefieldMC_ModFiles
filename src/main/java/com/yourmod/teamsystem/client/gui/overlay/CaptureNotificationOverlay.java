...
public class CaptureNotificationOverlay {
    ...
    public void render(GuiGraphics g, int screenWidth, int screenHeight) {
        ...
        RenderHelper.roundedRect(g, x - 10, y - 14, BAR_W + 20, PANEL_H, 4,
            AnimationHelper.withAlpha(UITheme.BG_HUD, (int) (fadeAlpha * 240)));
        ...
        RenderHelper.glow(g, x + BAR_W / 2 - tw / 2 - 4, y - 14, tw + 8, font.lineHeight + 6,
            0xFFFFFFFF, 3, fadeAlpha * glowIntensity * 0.3f);

        g.drawString(font, label, x + BAR_W / 2 - tw / 2, y - 10,
            AnimationHelper.withAlpha(teamColor, (int) (fadeAlpha * 255)));
        g.drawString(font, label, x + BAR_W / 2 - tw / 2 + 1, y - 9,
            AnimationHelper.withAlpha(UITheme.TEXT_PRIMARY, (int) (fadeAlpha * 220)));

        int barY = y + 6;
        int spacing_extra = 10;
        ...
        int barBgColor = AnimationHelper.withAlpha(UITheme.HUD_HP_BG, (int) (fadeAlpha * 200));
        RenderHelper.roundedRect(g, x, barY, BAR_W, BAR_H, 3, barBgColor);
        ...
        int team2Color = (capturingTeam == 0) ? UITheme.TEAM_RUSSIA : UITheme.TEAM_NATO;
        ...
        g.drawString(font, statusText, x + BAR_W / 2 - sw / 2, y + 24,
