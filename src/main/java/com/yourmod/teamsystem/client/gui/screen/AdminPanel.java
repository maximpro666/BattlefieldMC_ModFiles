...
public class AdminPanel extends Screen {
    ...
    private void requestKitConfig() {
        com.yourmod.teamsystem.network.PacketHandler.CHANNEL.sendToServer(
            new com.yourmod.teamsystem.network.KitAdminRequestPacket());
    ...
    private void kitSaveToServer() {
        ...
        try {
            ...
            com.yourmod.teamsystem.network.PacketHandler.CHANNEL.sendToServer(
                new com.yourmod.teamsystem.network.KitAdminSavePacket(json));
        } catch (Exception ignored) {}
    }
    ...
    private void renderMapsTab(GuiGraphics g, int x, int y, int w, int h) {
        ...
        cy += 30;
        g.drawString(font, "Use /teamsystem admin addmap <name> <path>", x, cy,
    ...
    private void renderConfigTab(GuiGraphics g, int x, int y, int w, int h) {
        ...
        cy += 30;
        g.drawString(font, "Config editing: /teamsystem admin config <key> <value>",
