...
import com.yourmod.teamsystem.client.gui.component.KitCard;
import com.yourmod.teamsystem.client.gui.component.SortControl;
...
public class KitSelectionScreen extends Screen {
    ...
    private void renderLeftPanel(GuiGraphics g, int mx, int my, float fade, int alpha, int leftW) {
        ...
        for (int i = 0; i < kitEntries.size(); i++) {
            ...
            String equippedId = com.yourmod.teamsystem.client.gui.screen.SpawnScreenHelper.getLastSelectedKit();
